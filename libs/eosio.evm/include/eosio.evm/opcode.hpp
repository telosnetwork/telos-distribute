...
namespace eosio_evm
{
  ...
  namespace OpFees {
    static uint16_t by_code[256] = {
      ...
      /* BALANCE        */  0,   // Get balance of the given account. (Dynamic as of EIP-2929)
      ...
      /* EXTCODESIZE    */  0,   // Get size of an account’s code. (Dynamic as of EIP-2929)
      /* EXTCODECOPY    */  0,   // Copy an account’s code to memory (Dynamic as of EIP-2929)
      ...
      /* EXTCODEHASH    */  0,   // (Dynamic as of EIP-2929)
      ...
      /* SLOAD    */  0,   // Load word from storage. (Dynamic as of EIP-2929)
      ...
      /* CALL         */  0,     // Message-call into an account (Dynamic as of EIP-2929)
      /* CALLCODE     */  0,     // Message-call into this account with an alternative account’s code (Dynamic as of EIP-2929)
      /* RETURN       */  0,     // Halt execution returning output data
      /* DELEGATECALL */  0,     // Message-call into this account with an alternative account’s code, but persisting the current values for sender and value. (Dynamic as of EIP-2929)
      /* CREATE2      */  32000,
      /* NULL         */  0,
      /* NULL         */  0,
      /* NULL         */  0,
      /* NULL         */  0,
      /* STATICCALL   */  0,     // Static message-call into an account. Exactly equivalent to CALL except: The argument µs is replaced with 0. (Dynamic as of EIP-2929)
      /* NULL         */  0,
      /* NULL         */  0,
